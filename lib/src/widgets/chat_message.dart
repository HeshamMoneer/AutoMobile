...
class ChatMessage extends StatelessWidget {
  ...
  Widget messageWidget(messageText, isMine) {
    return Padding(
        ...
        children: <Widget>[
          ...
          Flexible(
            ...
            children: [
              ...
              Flexible(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isMine ? Colors.grey.shade900 : Colors.grey.shade300,
              ...
              if (isMine) CustomPaint(painter: Triangle(Colors.grey.shade900)),
            ],
          )),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return messageWidget(curMessage.content, isMine);
  }
}
